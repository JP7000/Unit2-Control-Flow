...
choice = "shorts" if temperature >= 75 else "jacket"
print(choice)

# Grade pass/fail status  
score = 85
# Use ternary to set passed to "yes" or "no"
pass_fail = "yes" if score >= 70 else "no"
print(f"Score: {score}, Passed: {pass_fail}")
...
# else:
#     drink = "water"
drink = "coffee" if tired else drink = "water"
...
status = "PASS" if student_score >= 70 else "FAIL"
